...
#define INV_I2C_ADDR       CONFIG_INV_I2C_ADDR
#define INV_SDA_PIN        CONFIG_INV_SDA_PIN
#define INV_SCL_PIN        CONFIG_INV_SCL_PIN
#define INV_DELAY          CONFIG_INV_DELAY

// UART
#define GPS_UART_NUM UART_NUM_1
#define GPS_BUFF_SIZE (1024)
#define GPS_RX_GPIO CONFIG_UART_RX_PIN
#define GPS_TX_GPIO CONFIG_UART_TX_PIN
