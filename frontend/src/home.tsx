		...
		<div className="min-h-screen flex flex-col bg-white">
			...
			<div className="flex flex-col items-center justify-center flex-1 text-center px-4 bg-gradient-to-b from-gray-50 to-white">
				...
				<p className="text-lg text-gray-600 max-w-xl mb-8">
					Remote monitoring, configuration, and analytics for your energy
					storage systems.
				</p>
				<Link
					to="/dashboard"
			...
			<footer className="bg-gray-900 text-white py-6">
				<div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
					<span className="text-lg font-bold">
						...
						{" and "}
						<a href="https://www.aceongroup.com/news/project-mettle/">METTLE</a>
						{" Projects"}
					</span>
					<div className="flex flex-col md:flex-row items-center text-gray-400 mt-2 md:mt-0 space-y-2 md:space-y-0 md:space-x-6">
						<span>
							Contact:{" "}
							<a
								href="mailto:aodhan.burke@liverpool.ac.uk"
								className="hover:text-blue-400"
							>
								aodhan.burke@liverpool.ac.uk
							</a>
							,{" "}
							<a
								href="mailto:yunfeng.zhao@liverpool.ac.uk"
								className="hover:text-blue-400"
							>
								yunfeng.zhao@liverpool.ac.uk
							</a>
						</span>
						<span>
							&copy; {new Date().getFullYear()} University of Liverpool
						</span>
					</div>
				</div>
			</footer>
