...
<body>
    <div class='container'>
        ...
        <form action='/validate_change' method='post'>
            ...
            <input type='text' placeholder='Enter value (0.1°C)' name='chg_inhibit_temp_low'>

            <label>Update charge maximum temperature (currently <span id='CITH'></span> 0.1°C): </label>
            <input type='text' placeholder='Enter value (0.1°C)' name='chg_inhibit_temp_high'>
