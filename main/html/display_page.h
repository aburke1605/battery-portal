    ...
    <div class='max-w-4xl mx-auto mt-10 space-y-10'>
        ...
        <div class='bg-white p-8 rounded-lg shadow-lg'>
            <div class='flex justify-between items-center'>
                ...
                <div class='flex flex-col space-y-4'>
                    <a href='/change' class='text-blue-700 underline hover:text-blue-900'>Change battery pack properties</a>
                    <a href='/connect' class='text-blue-700 underline hover:text-blue-900'>Connect to WiFi access point</a>
                    <a href='/nearby' class='text-blue-700 underline hover:text-blue-900'>Nearby battery packs</a>
