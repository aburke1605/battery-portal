...
# Mysql database
MYSQL_HOST = os.getenv("AZURE_MYSQL_HOST")
MYSQL_PORT = os.getenv("AZURE_MYSQL_PORT")
MYSQL_USER = os.getenv("AZURE_MYSQL_USER")
MYSQL_PASSWORD = os.getenv("AZURE_MYSQL_PASSWORD")
MYSQL_DATABASE = os.getenv("AZURE_MYSQL_NAME")
